---
title: "Sample Plot Markdown AirHist"
...
plot(x=airquality$Month, y=airquality$Temp, xlab="Month", ylab="Tempurature", main="Temperature by Month")
```
